% Simulation of precoding schemes for single stream per user with power distribution
...
%             p3 = PowerDistribution_Reciprocal(gama3);
...
%             capacity3=capacity3+real(capacity_temp);
            ...
            % SLNR
            [u4, SLNR_val] = SLNR_PD(N,Mi,S,K,H,sigma2);
            p4 = PowerDistribution_Reciprocal(SLNR_val);
